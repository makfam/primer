...
```{r, echo=TRUE}
set.seed(10)
urn <- tibble(color = c(rep("red", 400), rep("white", 1500))) %>%
  sample_frac() %>% 
  mutate(ID = 1:1000) %>% 
  select(ID, color)
