...
<!-- Put Hypothesis section right before using the posterior. Give a clear two paragraph description of hypothesis test. "Traditionally, most scientific papers are not so much interested in estimating p. They are interested in testing specific hypotheses." Explain it exactly the way that Khan explains it. -->
...
To emphasize the ease with this method of creating our joint distribution compared to our previous example, let's show the two created figures next to one another:

<!-- MF: Add patchwork here. -->
...
The answer is about `r round(100 *sum(post_dist$new_reds > 8) /  length(post_dist$new_reds))`%. To examine the validity of this conclusion, let's look to our Cardinal Virtues. 
