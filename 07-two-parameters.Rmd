...
<!-- Clean up discussion of representativeness now that we are no longer quoting the details. Give a brief paragraph about how a non-representative sample might have happened. Are people in hospitals sampled? If there are certain categories of people that are harder to reach, then it may not be representative. Always think up reasons why your sample is not representative and then discuss the bias which might result. Also, you are sampling at a moment in time. There are always (potential time trends). MF: DONE. -->
