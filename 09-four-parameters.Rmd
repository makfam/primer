...
To put this in terms of the Preceptor tables, a *within unit* comparison is looking at one **row** of data: the data for Joe under control and the data for Joe under treatment. We are comparing **one unit**, or (in this case) one person, to itself under two conditions. An *across unit* comparison is looking at multiple rows of data, with a focus on differences across columns. We are comparing differences *without making any causal claims*. 
...
* The explanatory variables are `treatment`, which says whether a commuter recieved treatment or control conditions, and `att_start`, which measures attitude at the start of the study. 
