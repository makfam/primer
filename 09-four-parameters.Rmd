...
- To compare two models, take a `loo()` regression and perform `loo_compare()`. This method of cross validation assesses how well our model performs on data it has not yet seen. 
