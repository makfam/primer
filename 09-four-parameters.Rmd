...
To conclude this chapter, we will look at a four parameter model. The model we will use will measure `att_end` as a function of `liberal` and `att_start`. First, we will create the object `fitted_1`, which will be our model. 
...
Now that we know what our data is showing us, we will need to tidy our data and extract values to create a parallel slopes model. 
...
# FALSE. We want to extract the liberal_false_intercept to indictate where the
