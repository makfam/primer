...
* Use standard errors to understand uncertainty in our parameter estimates. If the standard error of a coefficient is large and we find no other reason to include it in our model, it may be a signal to remove the variable from your model. 

* If the variable has a small standard error, it is general practice to include it in our model to improve predictions.
