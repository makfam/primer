...
ggplot(ch10, aes(x = c_election_age, y = lived_after, color = sex)) +
  ...
  labs(title = "Interaction Model",
       subtitle = "Comparing post election livespan across sex",
       x = "Years Lived (Plus or Minus Average Age) Time of Election", 
...
The male line seems more sensible, as we might expect with far more datapoints. For male candidates, we see a clear (sensible) pattern: the older they are at the time of election, the less years post-election they lived. This makes sense, as we are limited by the human lifespan. 
